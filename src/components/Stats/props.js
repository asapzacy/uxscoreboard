...
export const nbaStatsProps = (game) => {
  ...
  return {
    ...
    'Rebounds': inGame ?
      [ Number(awayStats.rebounds_defensive) + Number(awayStats.rebounds_offensive) + Number(awayStats.team_rebounds),
        Number(homeStats.rebounds_defensive) + Number(homeStats.rebounds_offensive) + Number(homeStats.team_rebounds)
      ] : empty,
